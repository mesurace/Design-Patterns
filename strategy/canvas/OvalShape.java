...
public class OvalShape implements TwoEndShape {
	...
	public void mousePressed(ScribbleCanvasListener scl, MouseEvent e) {
        ...
        scl.onscreen.drawOval(scl.xStart, scl.yStart, 1, 1);
    }
    ...
    public void mouseReleased(ScribbleCanvasListener scl, MouseEvent e) {
        ...
        scl.offscreen.drawOval(scl.xStart, scl.yStart, p.x - scl.xStart + 1, p.y - scl.yStart + 1);
        scl.canvas.repaint();
    }
    ...
    public void mouseDragged(ScribbleCanvasListener scl, MouseEvent e) {
        ...
        if (scl.canvas.mouseButtonDown) {
            scl.onscreen.drawOval(scl.xStart, scl.yStart, scl.canvas.x - scl.xStart + 1, scl.canvas.y - scl.yStart + 1);
            scl.onscreen.drawOval(scl.xStart, scl.yStart, p.x - scl.xStart + 1, p.y - scl.yStart + 1);
        }
        scl.canvas.x = p.x;
        scl.canvas.y = p.y;
    }
