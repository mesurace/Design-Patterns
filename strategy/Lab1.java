...
import com.cs525.canvas.EraserTool;
import com.cs525.canvas.LineShape;
import com.cs525.canvas.OvalShape;
import com.cs525.canvas.RectShape;
import com.cs525.canvas.ScribbleCanvas;
import com.cs525.canvas.ScribbleCanvasListener;
import com.cs525.canvas.ScribbleTool;
import com.cs525.canvas.TwoEndsTool;
...
public class Lab1 extends JFrame {
	...
	protected void addToolbarButtons(JToolBar toolBar) {
		...
		clearb = new JButton(new ImageIcon("images/clear.gif"));
		...
		scribbleb = new JButton(new ImageIcon("images/scribble.gif"));
		...
		lineb = new JButton(new ImageIcon("images/line.gif"));
		...
		rectangleb = new JButton(new ImageIcon("images/rectangle.gif"));
		...
		ovalb = new JButton(new ImageIcon("images/oval.gif"));
		...
		eraseb = new JButton(new ImageIcon("images/eraser.gif"));
	...
	void lineb_actionPerformed(ActionEvent event) {
		...
		setCurrentTool(new TwoEndsTool(new LineShape()));
	}

	void rectangleb_actionPerformed(ActionEvent event) {
		System.out.println("rectangle");
		setCurrentTool(new TwoEndsTool(new RectShape()));
	}

	void ovalb_actionPerformed(ActionEvent event) {
		System.out.println("oval");
		setCurrentTool(new TwoEndsTool(new OvalShape()));
	}

	void eraseb_actionPerformed(ActionEvent event) {
		System.out.println("erase.");
		setCurrentTool(new EraserTool());
	}
